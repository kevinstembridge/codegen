...
// Rendered at: 2016-08-23T21:38:28.214Z
...
@Repository
public class SimpleDaoSample extends AbstractEntityDao<SimpleEntity> {
    ...
    @Autowired
    public SimpleDaoSample(final MongoClientFacade mongoClientFacade) {
    ...
    protected SimpleEntity toEntityFrom(final Document document) {
        ...
        final Map<String, Integer> someMapOfStringToInteger = readMap((s) -> s, this::readInteger, "mosti", "someMapOfStringToInteger", document);
        final Map<SomeStringType, SomeStringType> someMapOfStringTypeToStringType = readMap(SomeStringType::new, (o) -> new SomeStringType((String) o), "mosttst", "someMapOfStringTypeToStringType", document);
